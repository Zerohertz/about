  ...
  list: [
    {
      ...
      descriptions: [
        {
          content: {
            en: "Developed and operated the company-wide LLM gateway and the in-house Kubernetes-based MLOps platform within the ML Platform team.",
            ko: "ML 플랫폼 팀 내에서 전사 서비스의 LLM 게이트웨이 및 Kubernetes 기반 사내 MLOps 플랫폼 개발 및 운영",
          },
        },
        {
          content: {
            en: "Led quota and region reallocation to secure multi-CSP, multi-region redundancy, and strengthened high availability and stability with retries, fallback, and a circuit breaker.",
            ko: "Quota 및 리전 재배분 주도로 CSP·리전 다중화 확보 및 retry, fallback, circuit breaker 도입으로 고가용성과 안정성 강화",
          },
        },
        {
          content: {
            en: "Applied guardrails and masking to the LLM gateway to meet financial industry audit requirements, and advanced Prometheus and Grafana based observability.",
            ko: "LLM 게이트웨이의 가드레일, 마스킹 적용을 통한 금융권 감사 요건 충족 및 Prometheus, Grafana 기반 관측 체계 고도화",
          },
        },
      ],
    },
