      ...
      descriptions: [
        {
          content: {
            ...
            ko: "[`vllm-project/production-stack`](https://github.com/vllm-project/production-stack) 배포 환경에서 올바른 바이너리 검색을 위해 `PATH`에 `/opt/venv/bin` 추가하여 `lmcache/vllm-openai` 컨테이너의 치명적 실행 실패 문제 해결",
          },
        },
      ],
    },
