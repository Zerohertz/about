      ...
      descriptions: [
        {
          ...
          descriptions: [
            ...
            {
              content: {
                en: "이차전지전극을 위한 멀티코터가 구비된 지능형 롤투롤 코팅시스템 개발, 산업통상자원부 (2022. 05 ~ 2023. 01)",
                ko: "이차전지전극을 위한 멀티코터가 구비된 지능형 롤투롤 코팅시스템 개발, 산업통상자원부 (2022. 05 ~ 2023. 01)",
              },
              descriptions: [
                {
                  content: {
                    en: "Roll-to-Roll 연속 공정 내 편심 롤 진단을 위한 신호 처리 및 모델 개발",
                    ko: "Roll-to-Roll 연속 공정 내 편심 롤 진단을 위한 신호 처리 및 모델 개발",
                  },
                },
              ],
            },
            {
              content: {
                en: "대면적 고효율 기능성 필름 대량 생산을 위한 스마트 인쇄 전자 제조 기술 개발, 한국연구재단 (2021. 01 ~ 2022. 12)",
                ko: "대면적 고효율 기능성 필름 대량 생산을 위한 스마트 인쇄 전자 제조 기술 개발, 한국연구재단 (2021. 01 ~ 2022. 12)",
              },
              descriptions: [
                {
                  content: {
                    en: "Roll-to-Roll slot-die coating 공정의 코팅층 진단 모델 및 Graphic User Interface 개발",
                    ko: "Roll-to-Roll slot-die coating 공정의 코팅층 진단 모델 및 Graphic User Interface 개발",
                  },
                },
              ],
            },
            {
              content: {
                en: "열주름 해석을 통한 보정 기술 및 정밀 장력제어 기술, LG 전자 (2022. 03 ~ 2022. 12)",
                ko: "열주름 해석을 통한 보정 기술 및 정밀 장력제어 기술, LG 전자 (2022. 03 ~ 2022. 12)",
              },
              descriptions: [
                {
                  content: {
                    en: "롤 정렬도 불량에 따른 사행량 예측 모델 개발",
                    ko: "롤 정렬도 불량에 따른 사행량 예측 모델 개발",
                  },
                },
              ],
            },
            {
              content: {
                en: "웹 핸들링 기반 롤 배치 최적화 및 Tilting에 따른 사행/주름 분석, LG 에너지솔루션 (2022. 05 ~ 2022. 12)",
                ko: "웹 핸들링 기반 롤 배치 최적화 및 Tilting에 따른 사행/주름 분석, LG 에너지솔루션 (2022. 05 ~ 2022. 12)",
              },
              descriptions: [
                {
                  content: {
            ...
            {
              content: {
                en: "자동차용 배터리 전극 소재 떨림 최소화를 위한 건조 시스템 해석 및 공기 부양 유닛 노즐 최적화, LG 에너지솔루션 (2022. 04 ~ 2022. 11)",
                ko: "자동차용 배터리 전극 소재 떨림 최소화를 위한 건조 시스템 해석 및 공기 부양 유닛 노즐 최적화, LG 에너지솔루션 (2022. 04 ~ 2022. 11)",
              },
              descriptions: [
                {
                  content: {
                    en: "소재 온도 분포 파악을 위한 열전도도 프로파일 개발",
                    ko: "소재 온도 분포 파악을 위한 열전도도 프로파일 개발",
                  },
                },
              ],
            },
            {
              content: {
                en: "R2R 인쇄 유연컴퓨터개발 연구센터, 한국연구재단 (2021. 06 ~ 2022. 05)",
                ko: "R2R 인쇄 유연컴퓨터개발 연구센터, 한국연구재단 (2021. 06 ~ 2022. 05)",
              },
              descriptions: [
                {
                  content: {
                    en: "Roll-to-Roll slot-die coating 공정의 meniscus vision data 기반 진행 방향 코팅층 두께 예측 모델 개발",
                    ko: "Roll-to-Roll slot-die coating 공정의 meniscus vision data 기반 진행 방향 코팅층 두께 예측 모델 개발",
                  },
                },
                {
                  content: {
                    en: "Roll-to-Roll 공정의 장력 전달 모델 시뮬레이터 개발",
                    ko: "Roll-to-Roll 공정의 장력 전달 모델 시뮬레이터 개발",
                  },
                  href: "https://github.com/Zerohertz/Roll-to-Roll-Simulation-GUI",
                },
                {
                  content: {
                    en: "Roll-to-Roll 공정의 수학적 사행 모델 시뮬레이터 개발",
                    ko: "Roll-to-Roll 공정의 수학적 사행 모델 시뮬레이터 개발",
                  },
            ...
            {
              content: {
                en: "머신러닝 기반의 지능형 친환경 머서라이징 시스템 실증, 한국산업기술평가관리원 (2021. 04 ~ 2022. 05)",
                ko: "머신러닝 기반의 지능형 친환경 머서라이징 시스템 실증, 한국산업기술평가관리원 (2021. 04 ~ 2022. 05)",
              },
              descriptions: [
                {
                  content: {
                    en: "Vision data 기반 머서라이징 공정 모니터링 시스템 개발",
                    ko: "Vision data 기반 머서라이징 공정 모니터링 시스템 개발",
                  },
                },
              ],
            },
            {
              content: {
                en: "복합형상 부품가공용 스마트 컴팩트 라인센터 개발, 한국산업기술평가관리원 (2021. 01 ~ 2021. 12)",
                ko: "복합형상 부품가공용 스마트 컴팩트 라인센터 개발, 한국산업기술평가관리원 (2021. 01 ~ 2021. 12)",
              },
              descriptions: [
                {
                  content: {
                    en: "Bearing 상태 진단 모델 및 Graphic User Interface 개발",
                    ko: "Bearing 상태 진단 모델 및 Graphic User Interface 개발",
                  },
