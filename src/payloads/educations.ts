  ...
  list: [
    {
      ...
      descriptions: [
        {
          content:
            "Thesis: [A study on feature variable density for a highly efficient diagnosis model of rotary machine in roll-to-roll continuous process](https://library.konkuk.ac.kr/search/i-discovery/2111877)",
        },
